						...
						<div class="main-header-left ">
							<div class="responsive-logo">
								<a href="{{url('index')}}" class="header-logo">
									<img src="{{asset('assets/img/brand/CGE2-re.png')}}" class="mobile-logo logo-1" alt="logo">
									<img src="{{asset('assets/img/brand/CGE2-re.png')}}" class="mobile-logo dark-logo-1" alt="logo">
								</a>
							</div>
							...
							<div class="main-header-center ms-4 d-sm-none d-md-none d-lg-block form-group">
								<div>
									<p style="color: azure;">&nbsp;&nbsp;{{ $day }} {{ $date }} <br>&nbsp;&nbsp;{{ $time }}</p>
								</div>
							</div>
						</div>
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
										<!-- <li class="dropdown nav-item">
											<a class="new nav-link" data-bs-target="#country-selector" data-bs-toggle="modal" href=""><svg class="header-icon-svgs" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
										...
										<!-- <li class="dropdown nav-item  main-header-message ">
											<a class="new nav-link" data-bs-toggle="dropdown" href="javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" width="24" height="24" viewBox="0 0 24 24">
										...
										<li class="dropdown nav-item main-header-notification d-flex">
											...
											<div class="dropdown-menu">
												<div class="menu-header-content text-start border-bottom">
													<div class="d-flex">
														<h6 class="dropdown-title mb-1 tx-15 font-weight-semibold">Notifications
														</h6>
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
											...
											<div class="dropdown-menu">
												<div class="menu-header-content p-3 border-bottom">
													<div class="d-flex wd-100p">
														...
														<div class="ms-3 my-auto">
															...
															</h6><span class="dropdown-title-text subtext op-6  tx-12">Premium
																Member</span>
														</div>
													</div>
												</div>
												...
												<!-- <a class="dropdown-item" href="{{url('chat')}}"><i class="far fa-smile"></i>
				                                    chat</a>
				                                <a class="dropdown-item" href="{{url('mail-read')}}"><i
				                                        class="far fa-envelope "></i>Inbox</a> -->
												<a class="dropdown-item" href="{{url('mail')}}"><i
														class="far fa-comment-dots"></i>Messages</a>
												<!-- <a class="dropdown-item" href="{{url('mail-settings')}}"><i class="far fa-sun"></i>
				                                    Settings</a> -->
												<button wire:click="logoutAccount" class="dropdown-item"><i
