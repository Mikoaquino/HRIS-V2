            ...
            <div className="flex flex-col">
              <div className="px-5 pb-8 pt-2">
                <div className="flex justify-between items-start space-x-16">
                  <div className="text-sm text-gray-500 min-w-[120px] pt-8">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-sm font-medium text-gray-700 mb-0.5">{work.employer}</p>
                    {work.reason && (
                      <p className="text-sm text-gray-500">Reason: {work.reason}</p>
                    )}
                  </div>
                  <div className="flex space-x-4 ml-32 pt-6">
                    {works.length > 1 && (
                      <button
                        onClick={() => {
