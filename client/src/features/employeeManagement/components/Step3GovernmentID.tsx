...
export const Step3GovernmentID: React.FC<Step3GovernmentIDProps> = ({ data, onUpdate }) => {
  ...
  return (
    <div className="bg-white p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label htmlFor="sssNumber" className="block text-sm font-medium text-gray-700 mb-2">
            SSS Number *
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="tinNumber" className="block text-sm font-medium text-gray-700 mb-2">
            TIN Number *
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="pagibigNumber" className="block text-sm font-medium text-gray-700 mb-2">
            Pag-IBIG Number *
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="philhealthNumber" className="block text-sm font-medium text-gray-700 mb-2">
            PhilHealth Number *
          </label>
          <input
            type="text"
