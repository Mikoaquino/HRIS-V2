...
$(function () {
  ...
  /*--- Apex (#chart) ---*/
  var options = _defineProperty(_defineProperty(_defineProperty({
    series: [17],
    chart: {
      height: 205,
      type: 'radialBar',
  ...
  }, "series", [83]), "labels", [""]), "color", '#fff');
  var chart = new ApexCharts(document.querySelector("#chart"), options);
  chart.render();
  /*--- Apex (#chart)closed ---*/

  /*--- Apex (#spark1) ---*/
  var spark1 = _defineProperty(_defineProperty({
    chart: {
      id: 'spark1',
      group: 'sparks',
      type: 'line',
  ...
  /*--- Apex (#spark2) ---*/
  var spark2 = _defineProperty(_defineProperty({
    chart: {
      id: 'spark2',
      group: 'sparks',
      type: 'line',
  ...
  /*--- Apex (#spark3) ---*/
  var spark3 = _defineProperty(_defineProperty({
    chart: {
      id: 'spark3',
      group: 'sparks',
      type: 'line',
  ...
  var spark4 = _defineProperty(_defineProperty({
    chart: {
      id: 'spark4',
      group: 'sparks',
      type: 'line',
  ...
  /*--- Apex (#spark5) ---*/
  var spark5 = _defineProperty(_defineProperty({
    chart: {
      id: 'spark5',
      group: 'sparks',
      type: 'line',
