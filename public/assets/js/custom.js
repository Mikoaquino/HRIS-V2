...
$(function () {
  ...
  (function () {
    ...
    if (bodyRtl) {
      ...
      (_document$getElementB = document.getElementById("style")) === null || _document$getElementB === void 0 || _document$getElementB.setAttribute("href", "http://127.0.0.1:8000/assets/plugins/bootstrap/css/bootstrap.rtl.min.css");
      ...
      $("head link#style").attr("href", $(this));
      (_document$getElementB2 = document.getElementById("style")) === null || _document$getElementB2 === void 0 || _document$getElementB2.setAttribute("href", "http://127.0.0.1:8000/assets/plugins/bootstrap/css/bootstrap.min.css");
    }
    ;
    // For RTL //
