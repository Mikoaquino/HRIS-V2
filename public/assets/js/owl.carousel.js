...
!function (t, e, i, s) {
  ...
  var _n = function n(e) {
    ...
    }, this._core.options = t.extend({}, _n.Defaults, this._core.options), this._core.$element.on(this._handlers);
  };
  _n.Defaults = {
    autoRefresh: !0,
  ...
  }, t.fn.owlCarousel.Constructor.Plugins.AutoRefresh = _n;
}(window.Zepto || window.jQuery, window, document), function (t, e, i, s) {
  var _n2 = function n(e) {
    ...
    }, this._core.options = t.extend({}, _n2.Defaults, this._core.options), this._core.$element.on(this._handlers);
  };
  _n2.Defaults = {
    lazyLoad: !1,
    lazyLoadEager: 0
  }, _n2.prototype.load = function (i) {
  ...
  }, _n2.prototype.destroy = function () {
    var t, e;
    for (t in this.handlers) this._core.$element.off(t, this.handlers[t]);
    for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null);
  }, t.fn.owlCarousel.Constructor.Plugins.Lazy = _n2;
}(window.Zepto || window.jQuery, window, document), function (t, e, i, s) {
  var _n3 = function n(i) {
    ...
    }, this._core.options = t.extend({}, _n3.Defaults, this._core.options), this._core.$element.on(this._handlers), this._intervalId = null;
    var s = this;
  ...
  }, _n3.prototype.destroy = function () {
    var t, e;
    for (t in this._handlers) this._core.$element.off(t, this._handlers[t]);
    for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null);
  }, t.fn.owlCarousel.Constructor.Plugins.AutoHeight = _n3;
}(window.Zepto || window.jQuery, window, document), function (t, e, i, s) {
  var _n4 = function n(e) {
    ...
    }, this._core.options = t.extend({}, _n4.Defaults, this._core.options), this._core.$element.on(this._handlers), this._core.$element.on("click.owl.video", ".owl-video-play-icon", t.proxy(function (t) {
      this.play(t);
    }, this));
  };
  _n4.Defaults = {
    ...
    videoHeight: !1,
    videoWidth: !1
  }, _n4.prototype.fetch = function (t, e) {
  ...
  }, _n4.prototype.thumbnail = function (e, i) {
    var s,
      n,
  ...
  }, _n4.prototype.stop = function () {
    this._core.trigger("stop", null, "video"), this._playing.find(".owl-video-frame").remove(), this._playing.removeClass("owl-video-playing"), this._playing = null, this._core.leave("playing"), this._core.trigger("stopped", null, "video");
  }, _n4.prototype.play = function (e) {
    var i,
  ...
  }, _n4.prototype.isInFullScreen = function () {
    var e = i.fullscreenElement || i.mozFullScreenElement || i.webkitFullscreenElement;
    return e && t(e).parent().hasClass("owl-video-frame");
  }, _n4.prototype.destroy = function () {
    var t, e;
    for (t in this._core.$element.off("click.owl.video"), this._handlers) this._core.$element.off(t, this._handlers[t]);
    for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null);
  }, t.fn.owlCarousel.Constructor.Plugins.Video = _n4;
}(window.Zepto || window.jQuery, window, document), function (t, e, i, s) {
  var _n5 = function n(e) {
    this.core = e, this.core.options = t.extend({}, _n5.Defaults, this.core.options), this.swapping = !0, this.previous = void 0, this.next = void 0, this.handlers = {
  ...
  }, _n5.prototype.clear = function (e) {
    t(e.target).css({
      left: ""
    }).removeClass("animated owl-animated-out owl-animated-in").removeClass(this.core.settings.animateIn).removeClass(this.core.settings.animateOut), this.core.onTransitionEnd();
  }, _n5.prototype.destroy = function () {
    var t, e;
    for (t in this.handlers) this.core.$element.off(t, this.handlers[t]);
    for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null);
  }, t.fn.owlCarousel.Constructor.Plugins.Animate = _n5;
}(window.Zepto || window.jQuery, window, document), function (t, e, i, s) {
  var _n6 = function n(e) {
    ...
    }, this._core.$element.on(this._handlers), this._core.options = t.extend({}, _n6.Defaults, this._core.options);
  };
  _n6.Defaults = {
    autoplay: !1,
    autoplayTimeout: 5e3,
    ...
    autoplaySpeed: !1
  }, _n6.prototype._next = function (s) {
    this._call = e.setTimeout(t.proxy(this._next, this, s), this._timeout * (Math.round(this.read() / this._timeout) + 1) - this.read()), this._core.is("interacting") || i.hidden || this._core.next(s || this._core.settings.autoplaySpeed);
  }, _n6.prototype.read = function () {
    return new Date().getTime() - this._time;
  }, _n6.prototype.play = function (i, s) {
    var n;
    this._core.is("rotating") || this._core.enter("rotating"), i = i || this._core.settings.autoplayTimeout, n = Math.min(this._time % (this._timeout || i), i), this._paused ? (this._time = this.read(), this._paused = !1) : e.clearTimeout(this._call), this._time += this.read() % i - n, this._timeout = i, this._call = e.setTimeout(t.proxy(this._next, this, s), i - n);
  }, _n6.prototype.stop = function () {
    this._core.is("rotating") && (this._time = 0, this._paused = !0, e.clearTimeout(this._call), this._core.leave("rotating"));
  }, _n6.prototype.pause = function () {
    this._core.is("rotating") && !this._paused && (this._time = this.read(), this._paused = !0, e.clearTimeout(this._call));
  }, _n6.prototype.destroy = function () {
    var t, e;
    for (t in this.stop(), this._handlers) this._core.$element.off(t, this._handlers[t]);
    for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null);
  }, t.fn.owlCarousel.Constructor.Plugins.autoplay = _n6;
}(window.Zepto || window.jQuery, window, document), function (t, e, i, s) {
  "use strict";

  var _n7 = function n(e) {
    ...
    }, this._core.options = t.extend({}, _n7.Defaults, this._core.options), this.$element.on(this._handlers);
  };
  _n7.Defaults = {
    nav: !1,
    ...
    dotsSpeed: !1,
    dotsContainer: !1
  }, _n7.prototype.initialize = function () {
    var e,
  ...
  }, _n7.prototype.destroy = function () {
    var t, e, i, s, n;
    for (t in n = this._core.settings, this._handlers) this.$element.off(t, this._handlers[t]);
    for (e in this._controls) "$relative" === e && n.navContainer ? this._controls[e].html("") : this._controls[e].remove();
    for (s in this.overides) this._core[s] = this._overrides[s];
    for (i in Object.getOwnPropertyNames(this)) "function" != typeof this[i] && (this[i] = null);
  }, _n7.prototype.update = function () {
    var t,
      e,
  ...
  }, _n7.prototype.onTrigger = function (e) {
    var i = this._core.settings;
    e.page = {
  ...
  }, _n7.prototype.current = function () {
    var e = this._core.relative(this._core.current());
    return t.grep(this._pages, t.proxy(function (t, i) {
      return t.start <= e && t.end >= e;
    }, this)).pop();
  }, _n7.prototype.getPosition = function (e) {
    var i,
      s,
      n = this._core.settings;
    return "page" == n.slideBy ? (i = t.inArray(this.current(), this._pages), s = this._pages.length, e ? ++i : --i, i = this._pages[(i % s + s) % s].start) : (i = this._core.relative(this._core.current()), s = this._core.items().length, e ? i += n.slideBy : i -= n.slideBy), i;
  }, _n7.prototype.next = function (e) {
    t.proxy(this._overrides.to, this._core)(this.getPosition(!0), e);
  }, _n7.prototype.prev = function (e) {
    t.proxy(this._overrides.to, this._core)(this.getPosition(!1), e);
  }, _n7.prototype.to = function (e, i, s) {
    var n;
    !s && this._pages.length ? (n = this._pages.length, t.proxy(this._overrides.to, this._core)(this._pages[(e % n + n) % n].start, i)) : t.proxy(this._overrides.to, this._core)(e, i);
  }, t.fn.owlCarousel.Constructor.Plugins.Navigation = _n7;
}(window.Zepto || window.jQuery, window, document), function (t, e, i, s) {
  "use strict";

  var _n8 = function n(i) {
    ...
    }, this._core.options = t.extend({}, _n8.Defaults, this._core.options), this.$element.on(this._handlers), t(e).on("hashchange.owl.navigation", t.proxy(function (t) {
  ...
  _n8.Defaults = {
    URLhashListener: !1
  }, _n8.prototype.destroy = function () {
    var i, s;
    for (i in t(e).off("hashchange.owl.navigation"), this._handlers) this._core.$element.off(i, this._handlers[i]);
    for (s in Object.getOwnPropertyNames(this)) "function" != typeof this[s] && (this[s] = null);
  }, t.fn.owlCarousel.Constructor.Plugins.Hash = _n8;
}(window.Zepto || window.jQuery, window, document), function (t, e, i, s) {
